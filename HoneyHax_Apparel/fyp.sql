...
CREATE TABLE `reviews` (
  ...
  KEY `product ID link` (`productId`),
  CONSTRAINT `product ID link` FOREIGN KEY (`productId`) REFERENCES `products` (`productId`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `voucher` (
  ...
  `voucherDiscount` varchar(45) NOT NULL,
...
-- Dump completed on 2021-05-18 13:46:53
-- MySQL dump 10.13  Distrib 8.0.20, for Win64 (x86_64)
--
...
--
-- Dumping routines for database 'flags'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
