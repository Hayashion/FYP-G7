...
CREATE TABLE `reviews` (
  ...
  KEY `review-product_idx` (`productId`),
  KEY `user-userid_idx` (`userId`),
  CONSTRAINT `review-product` FOREIGN KEY (`productId`) REFERENCES `products` (`productId`) ON DELETE CASCADE,
  CONSTRAINT `user-userid` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
...
INSERT INTO `users` VALUES (1,'AlexYeo'),(2,'AlvinTan');
...
CREATE TABLE `voucher` (
  ...
  `voucherDiscount` int(3) NOT NULL,
