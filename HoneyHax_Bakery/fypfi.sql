CREATE DATABASE  IF NOT EXISTS `foodshop` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `foodshop`;
...
-- Dump completed on 2021-05-24 21:05:43
...
CREATE TABLE `input` (
  ...
  `adminNo` varchar(45) NOT NULL,
  `vulnId` varchar(45) NOT NULL,
  `userinput` varchar(1000) NOT NULL,
  `time_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`inputId`),
  UNIQUE KEY `inputId_UNIQUE` (`inputId`),
  UNIQUE KEY `vulnId_UNIQUE` (`vulnId`),
  KEY `userid key_idx` (`adminNo`),
  KEY `vulnid link_idx` (`vulnId`),
  CONSTRAINT `adminNo Link` FOREIGN KEY (`adminNo`) REFERENCES `students` (`adminNo`),
  CONSTRAINT `vuln link` FOREIGN KEY (`vulnId`) REFERENCES `flagtable` (`vulnId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `students` (
  ...
  `password` varchar(45) NOT NULL,
  `adminNo` varchar(7) NOT NULL,
  `studentClass` varchar(45) NOT NULL,
  `dateCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `vulnId` varchar(1000) NOT NULL,
  PRIMARY KEY (`adminNo`),
...
-- Dump completed on 2021-05-24 21:05:44
